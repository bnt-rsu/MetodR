...
![Локальное изображение](image/36.jpg "Увеличение слотов")

Рисунок 36. Увеличение слотов

![Локальное изображение](image/37.jpg "Схема подключения рабочих станций и DHCP-сервер")

Рисунок 37. Схема подключения рабочих станций и DHCP-сервер

Зайдем в настройки сервера во вкладку «Services» пункт «DHCP», задаем следующие параметры и применяем настройки «Save»:

![Локальное изображение](image/38.jpg "Настройки DHCP-сервера")
...
![Локальное изображение](image/39.jpg "Рабочая станция")
